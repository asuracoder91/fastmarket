      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                _SnsIcon(icon: Assets.icon.icoInstagram.path),
                _SnsIcon(icon: Assets.icon.icoFb.path),
                _SnsIcon(icon: Assets.icon.icoBlog.path),
                _SnsIcon(icon: Assets.icon.icoNaverpost.path),
                _SnsIcon(icon: Assets.icon.icoYoutube.path),
              ],
            ),
            SizedBox(height: 16),
            Text(
...
class _GreyInfo extends StatelessWidget {
  ...
  const _GreyInfo(this.text, {super.key, this.isBold = false});
...
class _HighlightInfo extends StatelessWidget {
  ...
  const _HighlightInfo(this.text, {super.key});
...
class _SnsIcon extends StatelessWidget {
  ...
  const _SnsIcon({super.key, required this.icon});
